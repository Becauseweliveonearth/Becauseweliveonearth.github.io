...
<h2 style="text-align: left;" markdown="1">
...
<button style="text-align: right;" markdown="1"> [Subscribe](https://mailchi.mp/62aa1e6258a4/because-we-live-on-earth){: .btn .btn-purple }</button>
</h2>
